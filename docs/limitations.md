...
- Tokenization is byte-level (`bytes % vocab_size`), not a production BPE/SentencePiece tokenizer.
...
| Production tokenizer | this doc § Training | BPE/SentencePiece integration |
