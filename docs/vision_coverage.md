...
- Vision KV-cache sliding-window RoPE evicts the oldest **text** row when `n_vision_prefix > 0` (`slide_rope_kv_window_at`); parity: `vision_sliding_window_past_max_ctx_*`, `rope_kv_slide_at_prefix_*`
