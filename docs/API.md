...
- `generate(prompt, max_new_tokens=32, temperature=0.0, top_k=0, top_p=0.0, min_p=0.0, repetition_penalty=1.0, use_kv_cache=True, bpe_encoder=None, unigram_encoder=None) -> str`
