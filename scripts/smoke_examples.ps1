...
Write-Host "== examples/gqa_rope_generate =="
& $PY examples/gqa_rope_generate.py
...
Write-Host "== examples/diffusion_edit_train =="
& $PY examples/diffusion_edit_train.py
...
Write-Host "== examples/diffusion_merge_demo =="
& $PY examples/diffusion_merge_demo.py
...
Write-Host "== examples/distribai_bridge =="
& $PY examples/distribai_bridge.py

Write-Host "== examples/train_glint2 --demo --fast --steps 8 =="
& $PY examples/train_glint2.py --demo --fast --steps 8 --batch-size 2 --shard-rows 16 --save-every 0 --out "$env:TEMP\glint2_smoke.mmn" --tokenizer tests/fixtures/glint_tokenizer_mini.json
