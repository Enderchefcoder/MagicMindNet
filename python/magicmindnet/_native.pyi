...
def write_npy(path: str, shape: list[int], data: list[float]) -> None: ...
...
def write_safetensors(path: str, arrays: list[tuple[str, list[int], list[float]]]) -> None: ...
...
def write_gguf_arrays(path: str, arrays: list[tuple[str, list[int], list[float]]]) -> None: ...
...
def write_h5(path: str, arrays: list[tuple[str, list[int], list[float]]]) -> None: ...
